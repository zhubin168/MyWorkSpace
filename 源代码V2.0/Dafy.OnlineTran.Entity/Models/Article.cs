...
namespace Dafy.OnlineTran.Entity.Models
{
    ...
    public partial class Article : IArticle
    {
        ...
        [BindColumn(4, "shareUrl", "文章分享图片", null, "nvarchar(500)", 0, 0, true)]
        ...
        [Description("文章列表图片")]
        [DataObjectField(false, false, true, 500)]
        [BindColumn(6, "listUrl", "文章列表图片", null, "nvarchar(500)", 0, 0, true)]
        ...
        [Description("正文链接")]
        [DataObjectField(false, false, true, 500)]
        [BindColumn(7, "contentUrl", "正文链接", null, "nvarchar(500)", 0, 0, true)]
        ...
        [Description("")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(15, "modifyName", "", null, "nvarchar(50)", 0, 0, true)]
